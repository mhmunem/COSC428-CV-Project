...
from hsi_classifier.config import LOG_DIR, RAW_DATA_DIR, DATASET_METADATA
...
class HSIDataDownloader:
    def __init__(self,
        ...
        self.data_file_path = self.dataset_dir / f"data.mat"
        self.label_file_path = self.dataset_dir / f"labels.mat"
